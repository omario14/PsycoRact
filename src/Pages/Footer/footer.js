    ...
    return (
        <div>
            ...
            <section className="footer">
                ...
                <div className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 text-center" data-aos="fade-left">
                            <h3>Contact</h3>
                            <a href="https://www.facebook.com/rotaractclubtunisnotredame">facebook</a>
                            <a href="/">twitter</a>
                ...
                <h1 className="credit text-center mx-auto">created by <span>Rotaract Tunis Notre Dame </span> | all rights reserved.</h1>
